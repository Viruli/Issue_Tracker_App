...
const DashboardScreen = () => {
  ...
  const { getIssueStats, issues, syncQueue, retrySyncQueue, loadIssues} = useIssueStore();
  ...
  >
    ...
    >
      ...
      <View style={summaryCard(palette)}>
        <Text style={summaryLabel(palette)}>
          All Issues
        </Text>

        <Text style={summaryValue(palette)}>
          {stats.all}
        </Text>
      </View>
